...
\subsection{Spazi}
L'edificio ha una pianta trapezoidale, presenta 8 cortili interni ed è diviso in tre sezioni:
\begin{itemize}
...
\subsection{La giustizia}
\begin{center}
  \includegraphics[scale=0.5]{statua.jpg}
\end{center}

Nel Cortile d'Onore (numero 5 sulla pianta) è presente un'imponente statua in porfido rosso e in marmo realizzata da \textit{Attilio Selva}.

\subsection{Giustizia armata con la legge}
\begin{center}
\includegraphics[scale=0.6]{mosaico.jpg}
\end{center}
...
\begin{center}
  \includegraphics[scale=0.6]{dipinto.png}
\end{center}

\vspace{1em}

Il dipinto è un olio su tela realizzato da \textit{Primo Conti} tra il 1936 e il 1938, e si trova in un'aula della sezione penale. Viene raffigurato il giudizio universale, e tra i personaggi si possono individuare \textit{Mussolini} e \textit{Napoleone} in attesa di essere giudicati.

\vspace{1em}

L'aver posto il Duce tra i giudicabili costò al pittore una deplorazione ufficiale e l'obliterazione delle sue opere fino al 1942.
